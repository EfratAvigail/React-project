  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" mt={4}>
      <Card sx={{ width: 600, padding: 3 }}>
        ...
        <MenuItem value={1}>ללא</MenuItem>
                         <MenuItem value={2}>קנוחים</MenuItem>
                         <MenuItem value={3}>עוגות</MenuItem>
                         <MenuItem value={4}>משקאות</MenuItem>
                         <MenuItem value={5}>תבשילים</MenuItem>
